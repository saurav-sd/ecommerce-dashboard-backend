...
Revision ID: aedc60a47bc3
Revises: 24d4ce63f384
Create Date: 2025-05-29 08:43:31.696862
...
revision: str = 'aedc60a47bc3'
down_revision: Union[str, None] = '24d4ce63f384'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'products', 'products', ['product_id'], ['id'])
